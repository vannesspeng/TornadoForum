UEditorUploadSettings = {
    ...
    "imageUrlPrefix": "http://127.0.0.1:8888/media/",
    ...
    "scrawlUrlPrefix": "http://127.0.0.1:8888/media/",
    "scrawlPathFormat": "upload/image/{yyyy}{mm}{dd}/{time}{rand:6}",

    # 截图工具上传 */
    "snapscreenActionName": "uploadimage",  # 执行上传截图的action名称 */
    "snapscreenPathFormat": "http://127.0.0.1:8888/media/",
    ...
    "videoUrlPrefix": "http://127.0.0.1:8888/media/",
    "videoAllowFiles": [
    ...
    "fileUrlPrefix": "http://127.0.0.1:8888/media/",  # 文件访问路径前缀 */
    "fileAllowFiles": [
    ...
    "imageManagerUrlPrefix": "http://127.0.0.1:8888/media/",  # 图片访问路径前缀 */

    # 列出指定目录下的文件 */
    "fileManagerActionName": "listfile",  # 执行文件管理的action名称 */
    "fileManagerListPath": "upload/file/",
    "fileManagerUrlPrefix": "http://127.0.0.1:8888/media/",
